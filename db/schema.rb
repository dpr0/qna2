...
ActiveRecord::Schema.define(version: 20150810054259) do
  ...
  add_index "attaches", ["attachable_id", "attachable_type"], name: "index_attaches_on_attachable_id_and_attachable_type", using: :btree
